...
(function ($) {
  ...
  if (testimonial) {
    ...
    // Testimonial Modal 1
    var modal_testimonial = document.querySelector("#modal_testimo nial");
    ...
    // Testimonial Modal 2
    var modal_testimonial_2 = document.querySelector("#modal_testi monial2");
    ...
    // Testimonial Modal 3
    var modal_testimonial_3 = document.querySelector("#modal_testim onial3");
